...
# Script: Get-Metadata
# Version: 2.1
# Author: Tin Aung Phyoe (tin.aung.phyoe@avanade.com)
...
# -maFileRows: set the max number of rows you want in the CSV. It will generate another file every time the script reach the limit. (default 300000)
#
# -----------------------------------------------------------------------------
